      ...
      <Container className="md:max-w-screen-xl flex-wrap mb-5 lg:gap-10 lg:flex-nowrap ">
        <div className="md:flex py-5">
          ...
          <div className="shadow p-5 md:w-1/2 mt-5 md:mt-0 relative md:p-10 bg-white rounded feedback-card-shadow">
            <QuoteIcon rightside />
            <div className="px-5" dangerouslySetInnerHTML={{ __html: t("feedback-1") }}></div>
          </div>
        </div>
        <div className="md:flex py-5">
          <div className="hidden md:block shadow p-5 md:w-1/2 mt-5 md:mt-0 relative md:p-10 bg-white rounded feedback-card-shadow">
            <QuoteIcon />
            <div className="px-5" dangerouslySetInnerHTML={{ __html: t("feedback-2") }}></div>
          </div>
          <div className="md:mb-5 md:w-1/2">
            <img
        ...
        <div className="md:flex py-5">
          ...
          <div className="shadow p-5 md:w-1/2 mt-5 md:mt-0 relative md:p-10 bg-white rounded feedback-card-shadow">
            <QuoteIcon rightside />
            <div className="px-5" dangerouslySetInnerHTML={{ __html: t("feedback-3") }}></div>
          </div>
        </div>
        <div className="md:flex py-5">
          <div className="hidden md:block shadow p-5 md:w-1/2 mt-5 md:mt-0 relative md:p-10 bg-white rounded feedback-card-shadow">
            <QuoteIcon />
            <div className="px-5" dangerouslySetInnerHTML={{ __html: t("feedback-4") }}></div>
          </div>
          <div className="md:mb-5 md:w-1/2">
            <img
              className="object-cover w-full h-full rounded relative md:right-5 md:bottom-5 -z-1"
